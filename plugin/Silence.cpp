...
{
    if (channels != 1) {
        ALOGE("Silence::initialise: channels must be 1");
        return false;
    }
...
//    ALOGE("Silence::getRemainingFeatures: m_lastTimestamp = " << m_lastTimestamp << ", m_lastChange = " << m_lastChange << ", m_apiVersion = " << m_apiVersion << ", m_prevSilent = " << m_prevSilent);
